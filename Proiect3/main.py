...
def main():
  ...
  parser.add_argument(
      '--overlap', default=1 / 6, type=float, help='How much neighbouring textures should overlap.')
  parser.add_argument(
      '--algorithm',
      required=True,
      type=str,
  ...
  parser.add_argument('--transfer-image', type=str, help='Which picture to transfer texture onto.')
  parser.add_argument(
