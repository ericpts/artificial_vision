...
def energy_horizontal_with_params(params: Parameters, blocks: List, output: ndarray, i: int, j: int,
                                  piece: int) -> ndarray:
    ...
    output_chunk = output[start_height:start_height + params.block_height, start_width:
...
def energy_vertical_with_params(params: Parameters, blocks: List, output: ndarray, i: int, j: int,
                                piece: int) -> ndarray:
    ...
    output_chunk = output[start_height:start_height + overlap_height, start_width:
...
def distance_horizontal_with_params(params: Parameters, blocks: List, output: ndarray, i: int,
                                    j: int, piece: int) -> ndarray:
...
def distance_vertical_with_params(params: Parameters, blocks: List, output: ndarray, i: int, j: int,
                                  piece: int) -> ndarray:
...
def texture_cost_with_params(params: Parameters, blocks: List, output: ndarray, i: int, j: int,
                             piece: int) -> float:
...
def place_with_params(params: Parameters, blocks: List, output: ndarray, i: int, j: int,
                      piece: int):
    ...
    np.copyto(
        dst=output[start_height:start_height + params.block_height, start_width:
                   start_width + params.block_width],
        src=blocks[piece],
        where=place_mask)
