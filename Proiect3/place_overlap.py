...
def place_overlap(params: Parameters, blocks: List) -> ndarray:
    ...
    def cost_horizontal(i: int, j: int, piece: int) -> float:
        ...
        return distance(
            output[start_height: start_height + params.block_height,
    ...
    def cost_vertical(i: int, j: int, piece: int) -> float:
        ...
        return distance(
            output[start_height: start_height + overlap_height,
    ...
    def get_best_fit(i: int, j: int) -> int:
        ...
        def cost(piece: int) -> float:
            ret = cost_horizontal(i, j, piece) + cost_vertical(i, j,
                                                               piece) - cost_overlap_vertical_horizontal(i, j, piece)
            return ret
