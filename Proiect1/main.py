...
def generate_image_in_memory(args):
    ...
    if args.random:
        chunks = split_image(
            target, horizontal_pieces_count, vertical_pieces_count, random_split=True)
    else:
...
def main():
    ...
    parser.add_argument(
        ...
        default=CIFAR_DIR,
        type=str,
        help='Where to find the project CIFAR pictures')
    parser.add_argument(
        '--random',
        dest='random',
        action='store_true',
    ...
    parser.add_argument(
        '--cifar_label', dest='cifar_label', type=str, help='What type of cifar pictures to use')
